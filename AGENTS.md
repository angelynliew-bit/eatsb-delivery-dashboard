...
Internal delivery tracking dashboard for East Asian Traders — imports daily spreadsheet data, counts unique deliveries and individual units, and provides weekly/monthly drill-down by channel, chain, store, and product.
